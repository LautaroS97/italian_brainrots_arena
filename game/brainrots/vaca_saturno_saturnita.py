    ...
    return Brainrot(
        ...
        skills=[
            Skill(
                ...
                animation={"file_root": f"{base}/patadon", "fps": 8}
            ),
            Skill(
                ...
                animation={"file_root": f"{base}/anillo_de_proteccion", "fps": 6}
            ),
            Skill(
                ...
                animation={"file_root": f"{base}/disco_de_acrecion", "fps": 5}
            ),
            Skill(
                name="Polvo Estelar",
                ...
                is_direct_attack=False,
                animation={"file_root": f"{base}/polvo_estelar", "fps": 6}
            )
        ]
    )
